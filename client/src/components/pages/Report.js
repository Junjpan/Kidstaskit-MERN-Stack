                    ...
                    <Motion style={{ y: spring(this.state.d3Panel ? 0 : -100), opacity: spring(this.state.d3Panel ? 1 : 0) }}>
                        {(currentStyles => (
                            <div style={{ ...this.d3style, transform: `translate3d(0,${currentStyles.y}%,0)`, opacity: currentStyles.opacity }}>
                                <button onClick={this.closeD3Panel} style={{ width: "200px", marginLeft: "20px", top: "50px", position: 'absolute' }}>Close</button>
                                <button onClick={this.d3todoview} style={{ width: "200px", background: "black", marginLeft: "20px", top: "150px", position: 'absolute' }}>To Do Score</button>
                                <button onClick={this.d3nottodoview} style={{ width: "200px", background: "red", marginLeft: "20px", top: "250px", position: 'absolute' }}>Not To Do Score</button>
                                <p style={{ fontSize: "30px", marginLeft: "20px", top: "350px", position: 'absolute' }}>{this.state.kid}</p>
                                <svg ref={node => this.node = node} width="80%" height="80%" style={{ border: "1px solid white", color: "black", marginTop: "3%", marginRight: "25px", padding: "15px", float: "right" }} ></svg>
